...
export const metadata: Metadata = {
  title: "NEk Essentials — Project | NEk LABS",
  description: "Detailed case study for NEk Essentials: a creative-technology project focused on video processing.",
};

export default function NekEssentialsPage() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans">
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="mb-12">
            <h1 className="flex flex-col tracking-tight mb-6 relative">
              ...
              <span className="text-[clamp(2.5rem,8vw,4.5rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.1em] md:-mt-[0.2em] lowercase">Essentials</span>
            </h1>
            <p className="text-xl md:text-2xl text-zinc-400 font-light tracking-wide uppercase">
              Creative Technology / Video Processing
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-white/10 text-xs uppercase tracking-widest font-bold">
            <div>
              ...
              <p>Creative Technology / Video Processing</p>
            </div>
            <div>
      ...
      <section className="w-full">
        <div className="w-full h-[40vh] md:h-[60vh] bg-black border-b border-white/10 relative overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="z-10 flex flex-col items-center justify-center tracking-tight relative text-center">
            ...
            <span className="text-[clamp(3.5rem,10vw,9rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.2em] md:-mt-[0.3em] lowercase">Essentials</span>
          </div>
        </div>
      </section>
      ...
      <article className="container mx-auto max-w-4xl px-6 py-24 space-y-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-2xl leading-relaxed font-light mb-8">
              <strong>NEk Essentials</strong> is a creative-technology project focused on simplifying the process of preparing video content for vertical social media formats.
            </p>
            <p className="text-zinc-400">
              The initial concept was specifically aimed at gym and fitness content creators, automatically transforming existing video content into properly framed vertical experiences for modern social platforms.
            </p>
          </div>
        </section>
        ...
        {/* Core Idea */}
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          <h2 className="text-sm font-bold text-zinc-500 uppercase tracking-widest sticky top-32 h-fit">Core Idea</h2>
...
{`LANDSCAPE / ORIGINAL VIDEO
  ...
  SOCIAL-READY VIDEO`}
            ...
            <div className="mt-8 border-l-2 border-zinc-500 pl-6 py-2">
              <p className="text-xl font-bold uppercase tracking-wide">Product Philosophy</p>
              <p className="text-zinc-400 mt-2">Instead of forcing creators to manually crop → reposition → resize → export, the system attempts to automate the repetitive work.</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
            <div>
              <ul className="text-zinc-400 text-sm space-y-4 list-disc list-inside">
                <li>Automatic 9:16 conversion</li>
                <li>Intelligent cropping</li>
                <li>Subject-aware framing</li>
                <li>Video processing</li>
                <li>Social media optimization</li>
                <li>Simplified editing workflow</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          ...
          <div>
            <div className="flex flex-wrap gap-3">
              {['Web application', 'Video processing', 'JavaScript', 'AI-assisted analysis', 'Automation'].map(tech => (
