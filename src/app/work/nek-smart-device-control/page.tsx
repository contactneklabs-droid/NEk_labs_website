...
export const metadata: Metadata = {
  title: "NEk Smart Device Control — Project | NEk LABS",
  description: "Detailed case study for NEk Smart Device Control: exploring QR-based pairing.",
};

export default function NekSmartDeviceControlPage() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans">
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="mb-12">
            <h1 className="flex flex-col tracking-tight mb-6 relative">
              ...
              <span className="text-[clamp(2.5rem,8vw,4.5rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.1em] md:-mt-[0.2em] lowercase">Smart Device Control</span>
            </h1>
            <p className="text-xl md:text-2xl text-zinc-400 font-light tracking-wide uppercase">
              PWA / Remote Device Control
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-white/10 text-xs uppercase tracking-widest font-bold">
            <div>
              ...
              <p>PWA / QR Pairing / Device Communication</p>
            </div>
            <div>
      ...
      <section className="w-full">
        <div className="w-full h-[40vh] md:h-[60vh] bg-black border-b border-white/10 relative overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="z-10 flex flex-col items-center justify-center tracking-tight relative text-center">
            ...
            <span className="text-[clamp(3.5rem,10vw,9rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.2em] md:-mt-[0.3em] lowercase">Smart Control</span>
          </div>
        </div>
      </section>
      ...
      <article className="container mx-auto max-w-4xl px-6 py-24 space-y-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-2xl leading-relaxed font-light mb-8">
              <strong>NEk Smart Device Control</strong> explored the idea of connecting a mobile device and desktop system through a QR-based pairing mechanism.
            </p>
            <p className="text-zinc-400">
              Instead of requiring complicated configuration, the user could scan a QR code to establish the connection for simple, secure local-network control.
            </p>
          </div>
        </section>
        ...
        {/* Workflow */}
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          <h2 className="text-sm font-bold text-zinc-500 uppercase tracking-widest sticky top-32 h-fit">Workflow</h2>
...
GENERATE PAIRING QR
 ...
 LOCAL CONNECTION
  ...
  REMOTE CONTROL`}
        ...
        {/* Core Components */}
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          <h2 className="text-sm font-bold text-zinc-500 uppercase tracking-widest sticky top-32 h-fit">Components</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
            <div>
              <ul className="text-zinc-400 text-sm space-y-4 list-disc list-inside">
                <li>QR pairing</li>
                <li>Mobile interface</li>
                <li>Desktop endpoint</li>
        ...
        {/* Engineering Focus */}
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          <h2 className="text-sm font-bold text-zinc-500 uppercase tracking-widest sticky top-32 h-fit">Engineering Focus</h2>
          <div>
            <div className="border-l-2 border-zinc-500 pl-6 py-2">
              <p className="text-xl font-bold uppercase tracking-wide">The important technical aspect wasn&apos;t the interface itself.</p>
              <p className="text-zinc-400 mt-2">It was the device-to-device communication model.</p>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          ...
          <div>
            <div className="flex flex-wrap gap-3">
              {['HTML', 'CSS', 'JavaScript', 'PWA architecture', 'QR-based pairing'].map(tech => (
