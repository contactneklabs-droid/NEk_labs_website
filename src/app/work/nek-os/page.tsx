...
export const metadata: Metadata = {
  title: "NEk OS — Project | NEk LABS",
  description: "Detailed case study for NEk OS: an experimental personal operating environment.",
};

export default function NekOsPage() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans">
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="mb-12">
            <h1 className="flex flex-col tracking-tight mb-6 relative">
              ...
              <span className="text-[clamp(2.5rem,8vw,4.5rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.1em] md:-mt-[0.2em] lowercase">OS</span>
            </h1>
            <p className="text-xl md:text-2xl text-zinc-400 font-light tracking-wide uppercase">
              Experimental Personal Operating Environment
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-white/10 text-xs uppercase tracking-widest font-bold">
            <div>
              ...
              <p>Experimental Systems / Productivity</p>
            </div>
            <div>
      ...
      <section className="w-full">
        <div className="w-full h-[40vh] md:h-[60vh] bg-black border-b border-white/10 relative overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="z-10 flex flex-col items-center justify-center tracking-tight relative text-center">
            ...
            <span className="text-[clamp(3.5rem,10vw,9rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.2em] md:-mt-[0.3em] lowercase">OS</span>
          </div>
        </div>
      </section>
      ...
      <article className="container mx-auto max-w-4xl px-6 py-24 space-y-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-2xl leading-relaxed font-light mb-8">
              <strong>NEk OS</strong> explores the idea of creating a unified personal digital environment where different productivity and control functions can exist within one system.
            </p>
            <p className="text-zinc-400">
              The project is an experimental exploration into building a unified digital workspace that combines productivity, system interaction and automation into one environment.
            </p>
          </div>
        </section>
        ...
        {/* Broader Concept */}
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          <h2 className="text-sm font-bold text-zinc-500 uppercase tracking-widest sticky top-32 h-fit">Direction</h2>
...
DIGITAL WORKSPACE`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12">
              <div className="border border-white/10 p-6">
                <p className="text-zinc-400 text-sm leading-relaxed">Centralized controls</p>
              </div>
              <div className="border border-white/10 p-6">
                <p className="text-zinc-400 text-sm leading-relaxed">Productivity tools</p>
              </div>
              <div className="border border-white/10 p-6">
                <p className="text-zinc-400 text-sm leading-relaxed">System interaction</p>
              </div>
              <div className="border border-white/10 p-6">
                <p className="text-zinc-400 text-sm leading-relaxed">Automation</p>
              </div>
              <div className="border border-white/10 p-6">
                <p className="text-zinc-400 text-sm leading-relaxed">Personal digital workspace</p>
              </div>
            </div>

            <div className="mt-8 border-l-2 border-zinc-500 pl-6 py-2">
              <p className="text-xl font-bold uppercase tracking-wide">Status Note</p>
              <p className="text-zinc-400 mt-2">This project is presented honestly as an experimental system concept, focusing on exploration rather than detailed technical implementation scope.</p>
            </div>
          </div>
        </section>
