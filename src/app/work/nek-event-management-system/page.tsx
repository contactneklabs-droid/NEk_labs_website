...
export const metadata: Metadata = {
  title: "NEk Event Management System — Project | NEk LABS",
  description: "Detailed case study for NEk Event Management System.",
};

export default function NekEventManagementPage() {
  return (
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="mb-12">
            <h1 className="flex flex-col tracking-tight mb-6 relative">
              ...
              <span className="text-[clamp(2.5rem,8vw,4.5rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.1em] md:-mt-[0.2em] lowercase">Event Management</span>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-white/10 text-xs uppercase tracking-widest font-bold">
            ...
            <div>
              ...
              <p>Completed Academic Project</p>
            </div>
            <div>
      ...
      <section className="w-full">
        <div className="w-full h-[40vh] md:h-[60vh] bg-black border-b border-white/10 relative overflow-hidden flex flex-col items-center justify-center">
          ...
          <div className="z-10 flex flex-col items-center justify-center tracking-tight relative text-center">
            ...
            <span className="text-[clamp(3.5rem,10vw,9rem)] font-playfair italic font-normal text-zinc-300 -mt-[0.2em] md:-mt-[0.3em] lowercase">Event System</span>
          </div>
        </div>
      </section>
      ...
      <article className="container mx-auto max-w-4xl px-6 py-24 space-y-32">
        ...
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-2xl leading-relaxed font-light mb-8">
              <strong>NEk Event Management System</strong> is a database-driven web-based platform for managing event registration and participant information.
            </p>
            <p className="text-zinc-400">
              It focuses on replacing manual registration workflows with a centralized database-driven system, greatly simplifying administrative workflows.
            </p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-[150px_1fr] gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
            <div>
              <h3 className="text-sm font-bold uppercase tracking-widest mb-4 pb-2 border-b border-white/20">Registration</h3>
              <p className="text-zinc-400 text-sm">Users can submit event registration details directly into the platform.</p>
            </div>
            <div>
              <h3 className="text-sm font-bold uppercase tracking-widest mb-4 pb-2 border-b border-white/20">Validation</h3>
              <p className="text-zinc-400 text-sm">Input validation prevents incomplete or invalid submissions.</p>
            </div>
            <div>
              <h3 className="text-sm font-bold uppercase tracking-widest mb-4 pb-2 border-b border-white/20">Duplicate Prevention</h3>
              <p className="text-zinc-400 text-sm">The system checks registration information to reduce duplicate entries.</p>
            </div>
            <div>
              <h3 className="text-sm font-bold uppercase tracking-widest mb-4 pb-2 border-b border-white/20">Admin Management</h3>
              <p className="text-zinc-400 text-sm">Administrators can manage Events, Participants, Registrations, and Records.</p>
            </div>
          </div>
        </section>
